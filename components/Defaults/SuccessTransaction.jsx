            ...
            <div className="py-6 pt-8 w-full max-w-sm bg-white rounded-lg shadow-none clip-path-mypolygon sm:p-8 dark:bg-gray-800 dark:border-gray-700">
              <div className="text-center">
                ...
                <p className="py-1 text-sm font-medium font-nunito text-primaryGrayText dark:text-blue-500">
                  Funds will be reflected shortly
                </p>
              </div>
              <div className="flow-root py-4">
                <ul role="list" className="divide-y divide-gray-200 dark:divide-gray-700">
                  ...
                  <li className="py-3 sm:py-4">
                    <div className="flex items-center space-x-4">
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-medium font-nunito text-primaryGrayText dark:text-white">Method</p>
                      </div>
                      <div className="inline-flex items-center dark:text-white">
                        <p className="text-sm font-medium font-nunito text-primaryTextColor">Card</p>
                      </div>
                    </div>
                  </li>
                  <li className="py-3 sm:py-4">
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="inline-flex items-center dark:text-white">
                        <p className="text-sm font-medium font-nunito text-primaryTextColor">Self</p>
                      </div>
                    </div>
                  </li>
                  <li className="py-3 sm:py-4">
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="inline-flex items-center dark:text-white">
                        <p className="text-sm font-medium font-nunito text-primaryTextColor">&#8358;65,000.00</p>
                      </div>
                    </div>
                  </li>
