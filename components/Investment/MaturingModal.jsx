...
const MaturingModal = props => {
  return (
    <>
      <Modal show={props.openMaturingModal === 'default'} onClose={() => props.setOpenMaturingModal(undefined)}>
        <div className="p-8">
        <div className="text-center relative">
            <h2 className=" text-2xl font-semibold font-nunito text-primaryTextColor">Investment Quote</h2>
            <span className="bg-primaryYellow text-primaryTextColor text-xs font-nunito font-bold absolute right-0 top-2 mr-6 px-2.5 py-1 rounded-full dark:text-green-900">
              Maturing
            </span>
          </div>
          <Modal.Body>
          ...
          <div className="text-center">
            <button
              type="submit"
              onClick={() => props.setOpenMaturingModal(undefined)}
...
MaturingModal.propTypes = {

}

export default MaturingModal;
