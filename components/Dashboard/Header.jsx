        ...
        <div className="px-6 py-8 max-w-lg bg-primaryBlue rounded-lg text-white shadow-xl dark:bg-gray-800 dark:border-gray-700">
          <div className="flex justify-between">
            ...
            <div>
              <button
                type="button"
                className="text-primaryBlue bg-primaryYellow hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-6 py-3 text-center inline-flex items-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
              >
