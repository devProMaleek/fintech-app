              ...
              <div className="flow-root py-4">
                <ul role="list" className="divide-y divide-gray-200 dark:divide-gray-700">
                  ...
                  <li className="py-3 sm:py-4">
                    <div className="flex items-center space-x-4">
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-medium font-nunito text-primaryGrayText dark:text-white">Biller</p>
                      </div>
                      <div className="inline-flex items-center dark:text-white">
                        <p className="text-sm font-medium font-nunito text-primaryTextColor">Biller Here</p>
                      </div>
                    </div>
                  </li>
                  <li className="py-3 sm:py-4">
                    <div className="flex items-center space-x-4">
                      ...
                      <div className="inline-flex items-center dark:text-white">
                        <p className="text-sm font-medium font-nunito text-primaryTextColor">Details Here</p>
                      </div>
                    </div>
                  </li>
                  <li className="py-3 sm:py-4">
...
SuccessBills.propTypes = {};

export default SuccessBills;
