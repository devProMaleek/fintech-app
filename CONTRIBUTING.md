# Contributing to spring-launch-website
...
This project is built in [React JS](https://reactjs.org/).
...
```shell
git clone https://devProMaleek07@bitbucket.org/cowries-developers/spring-launch-page.git
cd spring-launch-page
```
